(module
 ...
 (global $src/beneficiaryvault/BeneficiaryVault/VAULT_COUNT_POINTER (mut i32) (i32.const 0))
 (global $src/beneficiaryvault/BeneficiaryVault/VAULTS_BASE_POINTER (mut i32) (i32.const 0))
 ...
 (data $125.1 (i32.const 10584) "\02\00\00\00P\00\00\00s\00r\00c\00/\00b\00e\00n\00e\00f\00i\00c\00i\00a\00r\00y\00v\00a\00u\00l\00t\00/\00B\00e\00n\00e\00f\00i\00c\00i\00a\00r\00y\00V\00a\00u\00l\00t\00.\00t\00s")
 (data $126 (i32.const 10684) "\1c")
 (data $126.1 (i32.const 10696) "\01")
 (data $127 (i32.const 10716) "L")
 (data $127.1 (i32.const 10728) "\02\00\00\006\00\00\00I\00n\00v\00a\00l\00i\00d\00 \00b\00e\00n\00e\00f\00i\00c\00i\00a\00r\00y\00 \00a\00d\00d\00r\00e\00s\00s")
 ...
 (data $131.1 (i32.const 11128) "\02\00\00\00\1a\00\00\00S\00t\00o\00r\00e\00d\00A\00d\00d\00r\00e\00s\00s")
 (data $132 (i32.const 11164) "<")
 (data $132.1 (i32.const 11176) "\02\00\00\00\"\00\00\00N\00o\00 \00v\00a\00u\00l\00t\00s\00 \00c\00r\00e\00a\00t\00e\00d")
 (data $133 (i32.const 11228) "L")
 (data $133.1 (i32.const 11240) "\02\00\00\00.\00\00\00T\00r\00a\00n\00s\00a\00c\00t\00i\00o\00n\00 \00i\00s\00 \00r\00e\00q\00u\00i\00r\00e\00d")
 (data $134 (i32.const 11308) "L")
 (data $134.1 (i32.const 11320) "\02\00\00\006\00\00\00O\00n\00l\00y\00 \00b\00e\00n\00e\00f\00i\00c\00i\00a\00r\00y\00 \00c\00a\00n\00 \00u\00n\00l\00o\00c\00k")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $start:src/beneficiaryvault/index~anonymous|0)
 (export "abort" (func $src/beneficiaryvault/index/abort))
 ...
 (func $start:src/beneficiaryvault/index~anonymous|0 (result i32)
  (local $0 i32)
  i32.const 8
  i32.const 34
  call $~lib/rt/stub/__new
  ...
  i32.store
  local.get $0
  global.get $src/beneficiaryvault/BeneficiaryVault/VAULT_COUNT_POINTER
 ...
 (func $src/beneficiaryvault/index/abort (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  local.get $0
  local.get $1
  local.get $2
  local.get $3
 ...
 (func $~lib/@btc-vision/btc-runtime/runtime/exports/index/execute (param $0 i32) (result i32)
  ...
  block $__inlined_func$~lib/@btc-vision/btc-runtime/runtime/contracts/OP_NET/OP_NET#execute@override$229
   ...
   if
    local.get $1
    i32.const 1581460600
    i32.eq
    if
     local.get $2
     local.get $0
     call $src/beneficiaryvault/BeneficiaryVault/BeneficiaryVault#createVault
     local.set $0
    ...
    if
     local.get $2
     call $src/beneficiaryvault/BeneficiaryVault/BeneficiaryVault#unlockByBeneficiary
     local.set $0
     br $__inlined_func$~lib/@btc-vision/btc-runtime/runtime/contracts/OP_NET/OP_NET#execute@override$229
    end
    local.get $1
    ...
    if
     ...
     i32.wrap_i64
     local.set $0
     global.get $src/beneficiaryvault/BeneficiaryVault/VAULTS_BASE_POINTER
     local.get $0
     i32.const 1
     i32.shl
     i32.add
    ...
    if
     ...
     i64.sub
     i32.wrap_i64
     call $src/beneficiaryvault/BeneficiaryVault/BeneficiaryVault#getBeneficiaryPointer
 ...
 (func $src/beneficiaryvault/BeneficiaryVault/BeneficiaryVault#getBeneficiaryPointer (param $0 i32) (result i32)
  global.get $src/beneficiaryvault/BeneficiaryVault/VAULTS_BASE_POINTER
  local.get $0
  i32.const 1
  i32.shl
 ...
 (func $src/beneficiaryvault/BeneficiaryVault/BeneficiaryVault#createVault (param $0 i32) (param $1 i32) (result i32)
  (local $2 i64)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
 ...
 (func $src/beneficiaryvault/BeneficiaryVault/BeneficiaryVault#unlockByBeneficiary (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=4
 ...
 (func $~start
  ...
  i32.const 65535
  i32.and
  global.set $src/beneficiaryvault/BeneficiaryVault/VAULT_COUNT_POINTER
  global.get $~lib/@btc-vision/btc-runtime/runtime/env/index/Blockchain
  call $~lib/@btc-vision/btc-runtime/runtime/env/BlockchainEnvironment/BlockchainEnvironment#get:nextPointer
  i32.const 65535
  i32.and
  global.set $src/beneficiaryvault/BeneficiaryVault/VAULTS_BASE_POINTER
  global.get $~lib/@btc-vision/btc-runtime/runtime/env/index/Blockchain
  local.tee $0
  i32.const 7680
  i32.store offset=28
